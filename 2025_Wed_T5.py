...
if "messages" in st.session_state:
    ...
    for message in st.session_state["messages"]:
        if message["role"] == "user":
            ...
            st.write(f"**구세주:** {message['content']}")