...
# 초기 프롬프트 설정
initial_prompt = (
    "당신은 사용자의 문장을 고치는 [버그 박사]입니다. 사용자는 문장의 오류를 계속해서 고칠 것이고, 당신은 그 문장에서 오류를 찾아내 출력할 것입니다."
...
# Streamlit 애플리케이션
st.title("버그 박사")
st.write("버그 박사는 업무용으로 사용할 수도 있고 게임처럼 사용할 수도 있습니다. 업무용으로 사용시 오류를 고쳐 내는 용도로 유용하게 사용할 수 있고, 게임용으로 사용시 재미있게 AI를 사용할 수 있으며 학습도 할 수 있습니다.")
