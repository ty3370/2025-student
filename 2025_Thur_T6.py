...
initial_prompt = (
    ...
    "4. 아메리카 보물: 문명의 성배. 방어력 15 증가. HP 1씩 계속 회복하고, 전투 중에만 활성화 하세요."
    ...
    "10% 확률로 만난 사람들이 사용자를 공격하게 하세요."
    "총은 5% 확률로 땅에서 줍거나, 상인이 판매합니다."
    "최소 5가지의 총 종류를 만드세요. (예: 산탄총 등)"
    "HP를 25로 고정하세요."
    "3% 확률로 다른 대륙에 갈 때 배가 침몰해 무인도로 가게 해 무인도 엔딩을 활성화 하십시오."
    "게임 시작하기 전에 사용자에게 히든 엔딩 활성 여부를 물으십시오."
    "일반적인 적은 공격 시 사용자에게 가해지는 데미지를 5HP, 보스몹은 10HP로 하세요."
    "보물을 얻기 전, HP가 25~50인 보스를 출현시키세요."
)
